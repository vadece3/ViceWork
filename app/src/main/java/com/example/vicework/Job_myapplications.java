...
public class Job_myapplications {
    ...
    public Job_myapplications(String jobgiver,String jobname,String startdate,String jobsearcher,String jobposition,String acceptence_status)
    {
